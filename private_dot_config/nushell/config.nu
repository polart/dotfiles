...
$env.HOMEBREW_BREWFILE = '/Users/polart/.config/Brewfile'
$env.XDG_CONFIG_HOME = '/Users/polart/.config'
$env.LESSHISTFILE = '/Users/polart/.cache/less/history'
$env.NODE_REPL_HISTORY = '/Users/polart/.cache/node/history'
$env.PAGER = 'ov'

fnm env --version-file-strategy=recursive --use-on-cd --json | from json | load-env
use std "path add"
